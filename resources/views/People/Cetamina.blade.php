...
<head>
    ...
    <title>Cetamina - We-Mind - Neuroservices</title>
...
<div class="page-container">
    ...
    <div class="page-title-section">
        <div class="page-title-background" style="background-image:url('{{asset('/images/neuroservices/cetaminaImg-01.png')}}')"></div>
        <div class="dot-matrix"></div>
        <div class="center">
            <div class="page-title-container">
                <h1 class="page-title"> <span style="white-space: nowrap;">Cetamina</span> </h1>
                <!--googleoff: all-->
                <h4 class="page-breadcrumb">
                    ...
                    <span style="white-space: nowrap;">
                        <a href="{{url('/Cetamina')}}" title="Cetamina">Cetamina</a>
                    </span> </h4>
                <!--googleon: all-->
            </div>
        </div>
            ...
            <div class="primary-column column force">
                ...
                <div class="section-nav nav column">
                    <ul class="tier-1">
                        ...
                        <li class="active-page active-section open parent-level">
                            <a href="{{url('/Cetamina')}}" title="Cetamina" class="destination">Cetamina</a>

                        </li>

                        <li class="parent-level"> <a href="{{url('/Diagnostico')}}" title="Diagnóstico" class="destination">Diagnóstico</a>
                ...
                <div id="main-content" class="primary-content column force" role="main">
                    <div class="block" data-block-id="13476">
                        <h2><strong><span style="line-height: 1.5em; color: #563f80;">Cetamina</span></strong></h2>
                        <p style="line-height: 1.5em">

                            A cetamina psiquiátrica é uma variante (isômero) da cetamina anestésica, droga de uso médico
                            amplamente generalizado e é indicada para o tratamento da depressão refratária, isto é, da
                            depressão que não responde aos medicamentos convencionais.<br><br>
                            Seu surgimento representa uma das maiores – senão a maior – revolução da farmacologia
                            psiquiátrica das últimas três décadas, posto que a cetamina apresenta três vantagens
                            fundamentais sobre todos os outros tratamentos antidepressivos existentes:<br>
                            Possui efeitos imediatos; possui baixa toxidade e baixos efeitos colaterais
                            (não engorda, nem impacta negativamente a vida sexual, por exemplo); não precisa ser usada
                            continuamente.<br>
                            Em abril de 2017, a revista científica da academia americana de medicina, o famoso JAMA,
                            publicou um artigo com o sugestivo título “Consensos no uso de cetamina para o tratamento
                            de transtornos do humor”
                            <a href="https://www.ncbi.nlm.nih.gov/pubmed/28249076" title="ncbi" >https://www.ncbi.nlm.nih.gov/pubmed/28249076</a>
                            <br><br>
                            ...
                            O artigo é
                            assinado por alguns dos mais proeminentes psiquiatras americanos e começa com a afirmação
                            de que ensaios clínicos randomizados e controlados por placebo revelam o efeito rápido e
                            robusto da cetamina na melhora dos sintomas da depressão. Este artigo é um dos muitos
                            balizadores dessa nova modalidade de tratamento psiquiátrico, que a clínica Neuroservices
                            oferece em primeira mão.<br><br>
                            À frente da nossa unidade clínica está o Prof. Dr. Acioly Lacerda PhD, considerado o
                            maior especialista do país em cetamina. O Prof. Acioly está à frente dos principais estudos
                            brasileiros no tema e lidera um consórcio internacional voltado aos avanços envolvendo
                            esta molécula.<br>
                            O tratamento com cetamina pode ser feito de diversas formas. A clínica Neuroservices
                            utiliza um protocolo desenvolvido pelo Prof. Acioly, que se tornou referência para os
                            próprios laboratórios farmacêuticos. Esse know-how traduz-se diretamente em melhores
                            condições de tratamento e maior eficácia.<br>
                            Paralelamente, é de se considerar que o Prof. Acioly liderou a criação do ambulatório de
                            cetamina da EPM-Unifesp, onde um time de pesquisadores vem desenvolvendo estudos controlados
                            de alto rigor. <br><br>As principais inovações na área chegam primeiramente às
                            nossas mãos e, assim, são repassadas aos nossos clientes, de modo a sempre lhes
                            garantir o acesso àquilo que as neurociências podem oferecer de melhor.
                            Converse com o seu médico e conte conosco se vocês precisarem.
