...
<head>
    ...
    <title>Pessoas | Centro de Neuromodulação</title>
    ...
    <meta property="og:title" content="Pessoas | Centro de Neuromodulação">
...
<div class="page-container">
    ...
    <!-- begin TITLE section -->
    <div class="page-title-section" style="background-color: #74AA50;">
        <div class="page-title-background" style="background-image:url('{{asset('/images/stockphotos/pessoas.jpg')}}')"></div>
        <div class="dot-matrix"></div>
        <div class="center">
            <div class="page-title-container">
                <h1 class="page-title"> <span style="white-space: nowrap;">Pessoas</span> </h1>
                <!--googleoff: all-->
                <h4 class="page-breadcrumb"> <span style="white-space: nowrap;"><a href="{{url('/')}}" title="Home">Home</a></span> <span aria-hidden="true">&gt;</span> <span style="white-space: nowrap;"><a href="{{url('/pessoas')}}" title="About Us">Pessoas</a></span> </h4>
                <!--googleon: all-->
            </div>
        </div>
    </div>
    ...
    <div class="main-content section">
        ...
        <div class="center force">
            ...
            <div class="primary-column column force">
                ...
                <div class="section-nav nav column">
                    <ul class="tier-1">
                        <li class="parent-level"> <a href="{{url('/sobrenos')}}" title="About Us" class="destination">Sobre Nós</a>
                            <ul class="tier-2">
                                <li class=""> <a href="{{url('/sobrenos')}}" title="University Leadership" class="destination">Parágrafo 1</a>
                                    <ul class="tier-3">
                                        <li class=""> <a href="http://president.jhu.edu/" title="Office of the President" class="destination">Ponto 1</a> </li>
                                        <li class=""> <a href="http://web.jhu.edu/administration/provost/" title="Office of the Provost" class="destination">Ponto 2</a> </li>
                                    </ul>
                                </li>
                        ...
                        <li class="parent-level"> <a href="{{url('/linhasdepesquisa')}}" title="Academics" class="destination">Linhas de Pesquisa</a>
                            <ul class="tier-2">
                                <li class=""> <a href="{{url('/linhasdepesquisa')}}" title="Advanced International Studies" class="destination">TNS</a> </li>
                                <li class=""> <a href="{{url('/linhasdepesquisa')}}" title="Applied Physics Laboratory" class="destination">TMS</a> </li>
                                <li class=""> <a href="{{url('/linhasdepesquisa')}}" title="Arts &amp; Sciences" class="destination">TDCS</a> </li>
                                <li class=""> <a href="{{url('/linhasdepesquisa')}}" title="Business" class="destination">Neurofeedback </a> </li>
                        ...
                        <li class="active-page active-section open parent-level"> <a href="{{url('/pessoas')}}" title="Admissions &amp; Aid" class="destination">Pessoas</a>
                        </li>
                    ...
                    <div class="block" data-block-id="13476">
                        ...
                        <div class="researcher">
                            ...
                            <div class="supporting-content-item teaser type-teaser force has-image js-transform" data-id="20521" data-type="teaser">
                                <div class="image" style="width:9em">
                                    <a href="{{$researcher->decisionhub_page}}" title="{{$researcher->name}}"><img src="{{asset($researcher->photo_url)}}" alt="{{$researcher->name}}"></a>
                                </div>
                                <h3 class="headline"><a href="{{$researcher->decisionhub_page}}" title="{{$researcher->name}}">{{$researcher->name}}</a></h3>
                                <div class="summary">
                                    <p>{{$researcher->bio}}</p>
                                </div>
                            </div>
            ...
            <!--googleoff: all-->
            <div id="bbSidebar" class="sidebar column" data-id="13683" role="complementary"></div>
            <!--googleon: all-->
        </div>
    </div>
    <!--googleoff: all-->
