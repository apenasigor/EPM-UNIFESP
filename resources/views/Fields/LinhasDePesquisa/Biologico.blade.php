...
<head>
    ...
    <title>Diagnóstico biológico - We-Mind - Neuroservices</title>
            ...
            <div class="page-title-container">
                ...
                <h4 class="page-breadcrumb">
                    ...
                    <span style="white-space: nowrap;">
                        ...
                        <span style="white-space: nowrap;">
                            <span aria-hidden="true">&gt;</span>
                        <a href="{{url('/Diagnostico/Biologico')}}" title="Diagnóstico Biológico">Diagnóstico Biológico</a>
                    </span> </h4>
                <!--googleon: all-->
            </div>
        </div>
            ...
            <div class="primary-column column force">
                ...
                <div id="main-content" class="primary-content column force" role="main">
                    <div class="block" data-block-id="13476">
                        <h2><strong><span style="line-height: 1.5em; color: #563f80;">Diagnóstico Biológico</span></strong></h2>
                        <p style="line-height: 1.5em">
                            <br>



                            Nossas avaliações biológicas caminham, pari passu, com a expansão das fronteiras das
                            neurociências clínicas e refletem nosso compromisso em trazer à clínica o mesmo rigor e
                            comprometimento que ofertamos à ciência. <br>Em consonância com esta premissa, dispomos dos
                            seguintes métodos:
                            <br><br>
                        <p class="textEffect" > Mapeamento cerebral:</p>
                            O mapeamento é a avaliação basilar para os tratamentos ofertados pela Neuroservices.
                            Sua função é a de produzir insights sobre os padrões de atividade elétrica do
                            cérebro, usando um equipamento não invasivo de eletroencefalografia quantitativa (QEEG)
                            de altíssimo nível.
                            <br><br>
                            O procedimento é simples: eletrodos à seco são dispostos sobre o escalpo e os padrões
                            elétricos do cérebro são registrados em três condições: olhos fechados, olhos abertos e
                            durante uma tarefa cognitiva. <br>Esses registros são analisados com vista à extração de
                            indicadores do funcionamento neurofisiológico do cliente, o que se dá em dois níveis:
                            no primeiro, nossos cientistas procuram indicações de anomalias neurológicas; no segundo,
                            o EEG é dividido em faixas frequenciais sabidamente relacionadas a processos psíquicos,
                            cognitivos e emocionais e tratamentos estatísticos são realizados para responder acerca
                            de desequilíbrios nestas esferas.
                            <br><br>
                        <p class="textEffect"> Endofenótipos:</p>
                            Uma série de marcadores biológicos vêm sendo utilizados para a melhor compreensão das
                            origens, rotas de progressão e direcionamentos de tratamentos de transtornos
                            psiquiátricos e doenças neurológicas.<br> A equipe de neurocientistas clínicos da
                            Neuroservices possui expertise para a execução de muitos destes testes, como por exemplo:
                            potenciais evocados em esquizofrenia e outros transtornos, reflexos orientativos no
                            diagnóstico precoce de Alzheimer, eletrofisiologia periférica em transtornos afetivos,
                            mapeamento cerebral preditivo da eficácia de tratamentos farmacológicos em psiquiatria e
                            outros mais. Fale com o seu médico e peça que nos contate se quiser saber mais.
                            <br><br>
                        <p class="textEffect">Genômica personalizada:</p>
                            A clínica Neuroservices possui uma estrutura completa de biobancos e capacidade de realização
                            de testes genômicos, cujos resultados podem ser importantes no fechamento de diagnósticos
                            psiquiátricos, neurológicos e outros. Peça ao seu médico que nos contate se quiser saber mais.
