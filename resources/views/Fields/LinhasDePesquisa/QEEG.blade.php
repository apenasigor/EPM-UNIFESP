    ...
    <div class="block" data-block-id="8015">
        ...
        <div class="type-image" data-id="16484">
            <div class="image embedded small-size align-right">
                <a href="{{asset('/images/Linha_de_pesquisa/QEEG_small.gif')}}" target="_blank"><img src="{{asset('/images/Linha_de_pesquisa/eeg_small.gif')}}" alt="QEEG - QUANTITATIVE ELECTROENCEPHALOGRAPHY"></a>
            </div>
        </div>
        <p>
