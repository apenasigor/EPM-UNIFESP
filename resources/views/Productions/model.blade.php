...
<head>
    ...
    <meta property="og:title" content="Produções | Centro de Neuromodulação">
    ...
    <link rel="stylesheet" href="{{asset('/css/program-explorer-9b85abcb64.css')}}">
    <style>
        a,
        button {
            color: #44693D;
        ...
        /*.main-content .button { color: #000000; } .main-content .button:hover { border-color: #44693D !important; color: #44693D !important; }*/
...
<body class="page page-id-13660 page-parent page-template-default page-layout_inner page-layout_full-width unscrolled hide-nav-fries show-nav-fries"><a class="skip-to-main" href="#main-content">Skip to main content</a>
<!--googleoff: all-->
...
<div class="page-container">
    <!--[if lt IE 9]> <p class="browse-happy">Você está usando um navegador <strong>antigo</strong>. Por Favor<a href="http://browsehappy.com/">atualize o seu navegador</a>.</p> <![endif]-->
    <!-- begin TITLE section -->
    <div class="minimal-title page-title-section type-" style="background-color: #44693D;" role="banner">
        <div class="center force">
            <div class="page-title-container column force">
                ...
                <h1 class="page-title column"> <span style="white-space: nowrap;">Produções</span> </h1> </div>
        </div>
    </div>
    <!-- end TITLE section -->
    @yield('Content')
